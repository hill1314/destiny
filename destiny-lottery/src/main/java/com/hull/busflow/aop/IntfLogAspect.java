package com.hull.busflow.aop;

import com.hull.busflow.annotations.IntfLog;
...
public class IntfLogAspect {
     ...
     * 配置切入点
     */
    @Pointcut("@annotation(com.hull.busflow.annotations.IntfLog)")
    public void aspect() {

    }

//    @Pointcut("@annotation(com.hull.destiny.annotations.IntfLogs)")
//    public void aspect2() {
//
//    }
